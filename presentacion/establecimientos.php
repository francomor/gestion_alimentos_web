...
<body onload="cargar()" style="background: #1c1d26;"> 
			...
			<div class="row ">
                        ...
                        <h4>Registro RNE</h4>
                           <div class="row">
                                    ...
                                    <div class="input-field col s6">
                                      <input id="venc" name="venc" type="text"   maxlength="12"  value="" pattern="[0-9]{4}-(0[1-9]|1[012])-(0[1-9]|1[0-9]|2[0-9]|3[01])" placeholder="2017-11-02">
                        ...
                        <input type="text" value="" name="rubros" id="rubros" hidden>                        
                         <li>
                             <input type="submit" id="op" name="submit" class="waves-effect waves-light btnl" data-target="modal1" value="Guardar" />
                         </li>
  ...
  <div id="modal1" class="modal">
    <div class="modal-content">
        ...
        <label style=" color:#000; font-size:1rem" id="alertDat" for="mensaje">Label</label></div>
